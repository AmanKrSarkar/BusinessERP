...
from database.purchase_register_db import get_purchase_register


class PurchaseRegisterWindow(QWidget):

    def __init__(self):

        super().__init__()

        self.setWindowTitle(f"{APP_NAME} - Purchase Register")
